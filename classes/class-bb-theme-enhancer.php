...
class BB_Theme_Enhancer {
    ...
    public function run() {
        ...
        // Add italic variants of the body font.
        add_filter('fl_body_font_family', [$this, 'fix_body_font_family']);
    ...
    public function fix_body_font_family($variants) {
        return array_merge(array_map('strval', $variants), array_map(function ($variant) {
            return "${variant}i";
        }, $variants));
    }

    public function lightbox_script() {
        wp_enqueue_script('kntnt-bb-child-theme-lightbox', THEME_URI . '/js/lightbox.js', [
            'jquery',
